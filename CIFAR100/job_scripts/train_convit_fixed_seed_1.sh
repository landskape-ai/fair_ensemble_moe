...
#SBATCH --output=/home/mila/d/diganta.misra/scratch/fair_moe/convit_fixed_seed_1.out
#SBATCH --error=/home/mila/d/diganta.misra/scratch/fair_moe/convit_fixed_seed_1.err
#SBATCH --no-requeue
