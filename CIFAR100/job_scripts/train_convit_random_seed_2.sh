#!/bin/bash
#SBATCH --job-name=convit_ensemble-2
#SBATCH --nodes=1
...
#SBATCH --output=/home/mila/d/diganta.misra/scratch/fair_moe/convit_seed_2.out
#SBATCH --error=/home/mila/d/diganta.misra/scratch/fair_moe/convit_seed_2.err
#SBATCH --no-requeue
